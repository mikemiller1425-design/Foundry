...
| **Operator observation** | ⏳ **Pending.** Field 10 requires the operator to run the full journey on the target Mac at 5120×1440 and confirm it feels responsive at desk distance. Not performed and not claimed. This rung's stop condition is **not met** until it is, and FBL-035 must not begin. |
